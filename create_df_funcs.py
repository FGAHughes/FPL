...
def create_element_master(main_response, current_gameweek):
    ...
    element_master[['xg_value', 'xa_value', 'xgc_value', 'saves', 'minutes', 'starts', 'bonus', 'defensive_contribution']] = all_element_stats
...
def predict_gameweek_points(element_master, team_master, gameweek, a_or_b):
    ...
    # Similar story with defensive contribution where we don't consider opponent difficulty
    expected_dc = element_master.defensive_contribution * (2/12)
    expected_dc[expected_dc > 2.0] = 2.0
