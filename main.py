...
from create_df_funcs import return_main_response, create_element_master, create_team_master, add_team_data, \
    predict_points
from time_funcs import save_update_time, update_or_not
...
def run_fpl_script(gw_comparison, force_update, manager_id):
    ...
    print(starting_xi)
    # Use the below to create a custom search
    # print(element_master[(element_master['element_type'] == 2) & (element_master['starts'] > 2)])
